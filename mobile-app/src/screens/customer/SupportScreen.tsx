  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: 'Search for available rides using the "Book Ride" option, select your preferred ride, choose the number of passengers, and proceed to payment.',
    },
    {
      ...
      >
        ...
        <View style={styles.faqSection}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('CustomerSupportTickets' as never)}
            activeOpacity={0.7}
          >
