...
export default function CustomerComplaints() {
  ...
  return (
    <PageContainer maxWidth="lg" title="My Complaints" subtitle="Raise complaints only for serious or unresolved issues">
  ...
  <Typography variant="body2" sx={{ color: 'text.secondary', mb: 1 }}>
    Customers should raise a complaint only for serious or unresolved issues such as:
  </Typography>

  <Box component="ul" sx={{ pl: 3, mb: 2 }}>
    <li>Rude, unsafe, or unprofessional behavior by a driver</li>
    <li>Safety or security concerns during a trip</li>
    <li>Repeated service failures or incorrect charges</li>
    <li>Issues not resolved after raising a support ticket</li>
    <li>Any experience that caused inconvenience or loss</li>
  </Box>

  <Typography variant="body2" sx={{ color: 'text.secondary' }}>
    ⚠️ Complaints are formally reviewed and may take longer to resolve.  
    For general issues, please use <strong>Support Tickets</strong>.
  </Typography>
</StandardCard>
      {error && (
